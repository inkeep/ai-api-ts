...
export namespace RecordTypeEnumerated$ {
    export const inboundSchema: z.ZodNativeEnum<typeof RecordTypeEnumerated> =
        z.nativeEnum(RecordTypeEnumerated);
    export const outboundSchema: z.ZodNativeEnum<typeof RecordTypeEnumerated> = inboundSchema;
}
