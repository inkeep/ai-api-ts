...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      components.CreateChatSessionWithChatResultInput$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v0/chat_sessions/chat_results")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateResponse$inboundSchema, { key: "ChatResult" }),
    M.sse(200, operations.CreateResponse$inboundSchema, {
